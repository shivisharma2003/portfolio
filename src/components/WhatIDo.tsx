        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Translating raw datasets into actionable business insights through exploratory data analysis, statistical analysis, and interactive dashboards.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Applying machine learning, predictive modeling, and deep statistical analysis using Python libraries to uncover complex data patterns.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
